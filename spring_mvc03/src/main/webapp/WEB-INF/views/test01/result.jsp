...
<body>
	...
	<h2>이미지보기</h2>
   	<img src="/resources/images/spring.png" style="width:100px;"><br>
   권장사항(상대주소) :<img src="resources/images/spring.png" style="width:100px;"><br>
    <img src='<c:url value="resources/images/spring.png" />' style="width:100px;"><br>
   권장사항 :<img src='<c:url value="/resources/images/spring.png" />' style="width:100px;"><br>
   <!--이미지는 무조건 webapp-리소스 파일에 두자.  -->
